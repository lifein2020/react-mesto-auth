...
function App() {
  ...
  const [isPreviewPopupOpened, setPreviewPopupOpened] = useState(false);
  const handlePreviewPopupOpened = () => {
      ...
      <body class="body">
        <div className="page">
          ...
          <Main onEditProfile={handleEditProfileClick} 
                ...
                onPreviewPopupOpened={handlePreviewPopupOpened}
          />
          <Footer />
        </div>
